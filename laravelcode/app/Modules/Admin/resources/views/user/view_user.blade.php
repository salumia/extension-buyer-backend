                                    ...
                                    <div class="col-md-6">
                                        <table class="table table-simple">
                                            <tbody>
                                                <tr>
                                                    <td>Profile Image:</td>
                                                    <th><img src="{{$user['detail']->image_path}}" alt="{{$user['detail']->name}}" height="100" width="100" ></th>
                                                </tr>
                                                 <tr>
                                                    <td>Name:</td>
                                        ...
                                        <table class="table table-simple">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>Status:</td>
                                                    @php
                                                        $Status=array('0'=>'Pending','1'=>'Enable','2'=>'Disable');
                                                    @endphp
                                ...
                                <?php $i = 1;  
                                  ...
                                  @foreach($extensions as $extension)
                                    <tr>
                                        ...
                                        @php
                                         $status=array('0'=>'Under Review ','1'=>'Approved','2'=>'Deal in Progress','3'=>'Sold','4'=>'Complet','5'=>'Rejected');
                                        @endphp
                                        <td>
                                            @foreach($status as $s => $s_value)
